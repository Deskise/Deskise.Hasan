                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" class="forms-sample" method="post" action="{{route('blog_posts.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" value="{{old('title_en')  }}" class="form-control" id="Category" placeholder="Category">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="details_en" rows="10" style="height: 200px"> </textarea>
                        </div>
