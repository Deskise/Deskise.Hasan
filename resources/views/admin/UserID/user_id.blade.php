                    ...
                    <tr>
                        ...
                        <td onclick="show_popup({{ json_encode(
                            ...
                            @foreach($user->assets->assets as $key => $image)
                                ...
                                @endphp
                                @if ($key < 3)
                                    <img src="{{ route('images', ['for'=>'user_assets', 'image'=>$image]) }}" class="position-relative d-inline-block" style="left: {{ $left }};" height="200">
                                @else
                                    <div class="text-white position-relative d-inline-flex" style="height: 33px;width: 33px;background:#000000db;justify-content: center;align-items: center;border-radius: 50%; left: {{ $left }}">...</div>
                                    @break
                                @endif
                            @endforeach
                        </td>
